...
CREATE TABLE TELEFONE (
  ...
  FK_USUARIO  INT(5) NOT NULL UNIQUE,
  TEL    VARCHAR(15) NULL
);
...
CREATE TABLE LUGAR (
  ...
  FK_USUARIO_TEL INT(5) NOT NULL UNIQUE
);
...
ALTER TABLE LUGAR ADD CONSTRAINT FK_LUG_ID_USR FOREIGN KEY (FK_USUARIO_TEL) REFERENCES USUARIO (ID_USUARIO);
